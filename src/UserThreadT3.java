    ...
    public void run(){
        ...
        while (attempts > 0) {
            ...
            if (X < M) {
                ...
                if (requestInt == 0) {
                    accessReq = "R";
                    System.out.println("Thread[" + id + "] is making a read request on object " + X);
                }
                if (requestInt == 1) {
                    accessReq = "W";
                    System.out.println("Thread[" + id + "] is making a write request on object " + X);
                }
            } else {
                ...
                accessReq = "allow";
                System.out.println("Thread[" + id + "] is making a domain switch to domain " + ((N + M) - X - 1));
            }
